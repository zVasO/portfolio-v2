// app/developpeur-web/[slug]/sur/[city]/page.tsx
...
// ✅ Génère toutes les routes (slug + city)
export function generateStaticParams() {
    return technologySlugs.flatMap((slug) =>
        ...
        <main id="main-content" className="bg-paper text-ink">
                        ...
                        <div className="space-y-6 rounded-lg border border-line bg-white p-8 shadow-xl">
                            ...
                            <ul className="grid gap-5">
                                {page.results.map((result) => (
                                    <li
                                        key={result.label}
                                        className="rounded-md bg-paper-2 p-5"
                                    >
                    ...
                    <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                        <div>
                            ...
                            <p className="mt-4 max-w-2xl text-lg text-ink-2">
                                Chaque prestation est pensée pour vous livrer un produit clé en
                                main et une équipe autonome sur la technologie {page.technology}.
                            </p>
                        </div>
                        <Link
                            href="#contact"
            ...
            <section className="mx-auto max-w-6xl px-6 py-20">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mt-4 text-lg text-ink-2">
                        Nous travaillons main dans la main avec vos équipes marketing,
                        produit et tech pour livrer rapidement des fonctionnalités qui
                        comptent.
                    </p>
                </div>
                ...
                <div className="mx-auto flex max-w-5xl flex-col gap-12 px-6 lg:flex-row lg:items-center">
                    <div className="flex-1 space-y-6">
                        ...
                        <p className="text-lg text-ink-2">
                            Chaque collaboration est structurée autour d’objectifs business
                            clairs et d’indicateurs suivis semaine après semaine.
                        </p>
                        <Link
                    ...
                    <div className="flex-1 space-y-6">
                        {page.testimonials.map((testimonial) => (
                            ...
                            >
                                ...
                                <p className="mt-6 text-lg italic text-ink-2">
                                    “{testimonial.quote}”
                                </p>
            ...
            <section className="mx-auto max-w-5xl px-6 py-20">
                <div className="rounded-lg border border-line bg-paper-2 p-12 text-center">
                    ...
                    <p className="mt-4 text-lg text-ink-2">
                        En 48 heures, vous recevez un plan d’action concret, des
                        recommandations techniques et un devis transparent.
                    </p>
            ...
            <section className="bg-paper-2 py-20">
                <div className="mx-auto max-w-5xl px-6">
                    ...
                    <p className="mt-4 text-center text-lg text-ink-2">
                        Les réponses aux questions qui reviennent le plus souvent. Besoin
                        d’une précision ? Écrivez-moi directement.
                    </p>
...
// ✅ Fonction utilitaire pour capitaliser correctement les villes
